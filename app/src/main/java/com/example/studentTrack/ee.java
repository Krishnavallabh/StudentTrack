...
public class ee extends AppCompatActivity {
    ...
    String[] Name = {"Dr. Pradyumna Kumar Sahoo, HOD ",
            " Dr. Basanti Ekka",
            "Prof. Prakash Chandra Patra",
            "Prof. Sushil Kumar Pati",
            "prof. Radhakrishna Das",
            "Prof. Niharika Sahoo",
            "Prof. Pritam Priyadarshini Das",
    };
...
//        tabHost.addTab(spec);
        ...
        getSupportActionBar().setTitle("Electrical Engg");
    }
    @Override
