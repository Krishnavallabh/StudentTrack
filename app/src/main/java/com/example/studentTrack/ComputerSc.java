...
public class ComputerSc extends AppCompatActivity {
    ...
    String[] Name = {"Dr. Anil kumar Mishra, HOD",
            "Dr. Sambit Kumar Mishra",
            "Prof. NilaMadab Mishra",
            "Prof. Neelamani Samal",
            "Prof. Tarun Kumar Behera",
            "Prof. Manas Ranjan Moharana",
            "Prof. Ranjita Rout",
            "Prof. Ambika Prasad Jena",
            "prof. Tophan Kumar Jena",
            "prof. Sutapa Roy Chowdhury"};


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_computer_sc);
...
//        tabHost.addTab(spec);
        ...
        getSupportActionBar().setTitle("Computer Sc");
    }
    @Override
